...
public:                                   // public functions
    ...
    Iterator end() const;                 // iterator to end entry
...
typename HashMap<K, V, H>::Iterator HashMap<K, V, H>::find(const K &k) const
{
...
typename HashMap<K, V, H>::Iterator HashMap<K, V, H>::end() const
{
